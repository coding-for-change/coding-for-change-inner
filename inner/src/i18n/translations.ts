...
const de: Translations = {
    ...
    home: {
        ...
        kicker: 'Sammeln Sie Programmiererfahrung und bewirken Sie etwas Gutes',
    ...
    threed: {
        ...
        title: 'Lust auf die szenische Route? Probieren Sie die 3D-Seite.',
        text: 'Es gibt eine verspielte 3D-Version dieser Seite – ein kleiner Retro-Desktop, den Sie direkt im Browser anklicken und erkunden können.',
        cta: '3D-Erlebnis starten',
        backKicker: 'Sie sind im 3D-Modus',
        backTitle: 'Lieber die schnelle, schlichte Version?',
        backText: 'Sie erkunden gerade die 3D-Version der Seite. Wechseln Sie jederzeit zurück zur normalen Seite – dort kommen Sie schneller voran.',
    ...
    caseStudy: {
        ...
        technicalCardText: 'Wie wir es gebaut haben – das Problem, unser Vorgehen und der Stack. Ideal, wenn Sie als Studierende:r übers Mitmachen nachdenken.',
        impactCardTitle: 'Impact-Story',
        ...
        impactLabel: 'Impact-Story',
        joinHeading: 'Möchten Sie so etwas bauen?',
        joinText: 'Genau solche echte, ausgelieferte Software bauen Sie als Mitglied – im Team, mit echtem Partner und Menschen, die darauf angewiesen sind.',
    ...
    events: {
        ...
        intro: 'Nehmen Sie an unseren kommenden Events teil oder schauen Sie sich an, was wir bisher erlebt haben!',
        upcoming: 'Kommende Events', past: 'Vergangene Events',
        emptyTitle: 'Aktuell kein Event',
        emptyText: 'Sie haben eine Idee für ein Event? Lassen Sie uns reden.',
    ...
    join: {
        benefits: 'Was Sie bekommen', requirements: 'Wen wir suchen',
        waysToContribute: 'Wie Sie mitwirken können', applyNow: 'Jetzt bewerben',
        nameLabel: 'Ihr Name:', namePlaceholder: 'Name',
        emailLabel: 'E-Mail:', emailPlaceholder: 'E-Mail',
        motivationLabel: 'Warum möchten Sie mitmachen?',
        motivationPlaceholder: 'Erzählen Sie uns von Ihrer Motivation...',
        sendApplication: 'Bewerbung absenden', unavailable: 'Inhalt nicht verfügbar.',
        submitting: 'Wird gesendet…',
        sendError:
            'Beim Senden Ihrer Bewerbung ist etwas schiefgelaufen. Bitte versuchen Sie es erneut oder schreiben Sie uns direkt.',
        loadingForm: 'Formular wird geladen…',
        formUnavailable:
            'Das Bewerbungsformular ist derzeit nicht verfügbar. Bitte schreiben Sie uns direkt.',
        successFallback: 'Danke! Ihre Bewerbung wurde gesendet.',
        requiredNote: '* = Pflichtfeld',
        waitlistTitle: 'Bewerbungen sind derzeit geschlossen',
        waitlistLead:
            'Tragen Sie sich ein und erfahren Sie als Erste:r, wenn die Bewerbungen wieder öffnen – wir schreiben Ihnen sofort, sobald es so weit ist.',
        waitlistEmailLabel: 'E-Mail:',
        waitlistEmailPlaceholder: 'name@beispiel.de',
        waitlistButton: 'Benachrichtigen Sie mich',
        waitlistSubmitting: 'Wird eingetragen…',
        waitlistSuccess:
            'Sie stehen auf der Liste! Wir melden uns, sobald die Bewerbungen wieder öffnen.',
        waitlistError:
    ...
    talk: {
        ...
        studentHeading: 'Möchten Sie etwas bewegen?',
        studentText: 'Sie sind Studierende:r und brennen dafür, etwas zu bewirken? Egal welcher Hintergrund – bei Coding for Change ist etwas für Sie dabei.',
